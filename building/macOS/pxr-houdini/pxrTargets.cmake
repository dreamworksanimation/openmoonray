...
#  INTERFACE_LINK_LIBRARIES "dl;/usr/lib64/libm.dylib"
)
...
set_target_properties(tf PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include;/Applications/Houdini/Houdini19.5.805/Frameworks/Python.framework/Versions/3.9/include/python3.9"
  INTERFACE_LINK_LIBRARIES "arch;${HPYTHONLIB};${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
...
set_target_properties(js PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
...
set_target_properties(trace PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "arch;js;tf;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
...
set_target_properties(work PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "tf;trace;${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(plug PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "arch;tf;js;trace;work;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(vt PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "arch;tf;gf;trace;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(pcp PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "tf;trace;vt;sdf;work;ar;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(usd PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "arch;kind;pcp;sdf;ar;plug;tf;trace;vt;work;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(usdGeom PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "js;tf;plug;vt;sdf;trace;usd;work;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(usdSkel PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "arch;gf;tf;trace;vt;work;sdf;usd;usdGeom;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(usdPhysics PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "js;tf;plug;vt;sdf;trace;usd;usdGeom;usdShade;work;${_BOOST_PYTHON_LIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include;${_DEPS_PREFIX}/include"
)
...
set_target_properties(garch PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
#  INTERFACE_LINK_LIBRARIES "arch;tf;/usr/lib64/libSM.dylib;/usr/lib64/libICE.dylib;/usr/lib64/libX11.dylib;/usr/lib64/libXext.dylib;/usr/lib64/libGL.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(pxOsd PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "tf;gf;vt;${_DEPS_PREFIX}/lib/libosdCPU.dylib;${_DEPS_PREFIX}/lib/libosdGPU.dylib;${_BOOST_PYTHON_LIB}"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(glf PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
#  INTERFACE_LINK_LIBRARIES "ar;arch;garch;gf;hf;hio;js;plug;tf;trace;sdf;${_BOOST_PYTHON_LIB};/usr/lib64/libGL.dylib;/usr/lib64/libSM.dylib;/usr/lib64/libICE.dylib;/usr/lib64/libX11.dylib;/usr/lib64/libXext.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(hd PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "plug;tf;trace;vt;work;sdf;cameraUtil;hf;pxOsd;${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(hdSt PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "hio;garch;glf;hd;hgiGL;hgiInterop;sdr;tf;trace;${_DEPS_PREFIX}/lib/libosdCPU.dylib;${_DEPS_PREFIX}/lib/libosdGPU.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(usdImaging PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gf;tf;plug;trace;vt;work;hd;pxOsd;sdf;usd;usdGeom;usdLux;usdShade;usdVol;ar;${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
...
set_target_properties(usdImagingGL PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${HPYTHONINC};${HPYTHONINC};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gf;tf;plug;trace;vt;work;hio;garch;glf;hd;hdx;pxOsd;sdf;sdr;usd;usdGeom;usdHydra;usdShade;usdImaging;ar;${_BOOST_PYTHON_LIB};${HPYTHONLIB};${_DEPS_PREFIX}/lib/libtbb.dylib"
...
set_target_properties(usdRiImaging PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "PXR_PYTHON_ENABLED=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_INCLUDE_PREFIX};${_DEPS_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gf;tf;plug;trace;vt;work;hd;pxOsd;sdf;usd;usdGeom;usdLux;usdShade;usdImaging;usdVol;ar;${_DEPS_PREFIX}/lib/libtbb.dylib"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_DEPS_PREFIX}/include"
)
